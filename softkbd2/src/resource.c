...
#include "320x240/rime_kbd_bkg.c"
...
#include "480x272/rime_kbd_bkg.c"
...
#include "240x320/rime_kbd_bkg.c"
...
static RESDATA res[] = {
    ...
    /* rime keyboard data */
    {"rime_kdb_bkg.png", (unsigned char *)rime_kbd_data, sizeof(rime_kbd_data)},
    /* char key mask data */
